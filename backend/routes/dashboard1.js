...
router.put(
    ...
    async (req, res, next) => {
        try {
            ...
            if (hrRating !== undefined && (isNaN(parsedHrRating) || parsedHrRating < 0 || parsedHrRating > 5)) {
            ...
            if (hrFeedbackProvided !== undefined) {
                interview.hrFeedbackProvided = hrFeedbackProvided;
                interview.processStatus = interview.hrFeedbackProvided ? "HR Reviewed" : "Analysis Complete";
            }
